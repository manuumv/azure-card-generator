...
export const LoginContainer: React.FunctionComponent = () => {
  const [user, setUser] = React.useState<User>({ name: '', organization: '', token: '', remember: false });
  ...
  const onChangeUser = React.useCallback((key: UserProperties, value: string | boolean) => (
